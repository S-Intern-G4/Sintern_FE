    ...
    return (
        <CardFeed>
            ...
            <TextCard>
                ...
                <Specialization>
                    <strong>Specialization:</strong> {studentApplier.educationDetails.specialization}
                </Specialization>
                <YearOfStudy>
                ...
                <PhoneNumber>
                    ...
                    {studentApplier.phoneNumber}
                </PhoneNumber>
                <Email>
                    <strong>Email:</strong>{' '}
                    {studentApplier.email}
                </Email>
                <DateOfBirth>
                    <strong>Date Of Birth:</strong>{' '}
                    {studentApplier.dateOfBirth}
                </DateOfBirth>
                <Description>
                    <strong>Description:</strong>{' '}
                    {studentApplier.description}
                </Description>
                <DateOfSubmission>
                    <strong>Date Of Submission:</strong>{' '}
                    {studentApplier.dateOfSubmission}
                </DateOfSubmission>
            </TextCard>
        </CardFeed>
    );
